...
void DiscountedCfrTrainableSF::dump_strategy(std::ostream& stream, bool with_state, const vector<vector<int>>& exchange_color_list, const shared_ptr<ActionNode>& node) {
    if (with_state) {
        stream << "{}";
        return;
    }
