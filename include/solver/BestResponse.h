...
public:
     BestResponse(vector<vector<PrivateCards>>& private_combos, int player_number,
                  ...
                  int color_iso_offset[][4], GameTreeNode::GameRound split_round,
                  int nthreads, int use_halffloats,
                  Solver::AnalysisMode analysis_mode, const vector<Card>& full_board_cards);
